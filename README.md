...
4. **`/youtube/search`:** This endpoint implements search API to fetch stored video data using their title and description and takes a query parameter to take the keywords. It shows results
```
